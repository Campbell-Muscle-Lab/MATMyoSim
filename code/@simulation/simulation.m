        ...
        function obj = implement_protocol(obj)
            ...
            for t_counter = 1:obj.sim_output.no_of_time_points
                ...
                for i=1:obj.m.no_of_half_sarcomeres
                    ...
                    % Storing rates
                   if (1)
                       obj.sim_output.rate_structure.b_pf(t_counter,i) = ...
                            obj.m.hs(i).rate_structure.b_pf;
                       obj.sim_output.rate_structure.k_off(t_counter,i) = ...
                            obj.m.hs(i).rate_structure.r_off;
                       obj.sim_output.rate_structure.b_k3(t_counter,i) = ...
                            obj.m.hs(i).rate_structure.b_k3;
                       obj.sim_output.rate_structure.k_1(t_counter,i) = ...
                            obj.m.hs(i).rate_structure.r1;
                       obj.sim_output.rate_structure.k_3(t_counter,i) = ...
                            max(obj.m.hs(i).rate_structure.r3);
                       obj.sim_output.rate_structure.k_4(t_counter,i) = ...
                            min(obj.m.hs(i).rate_structure.r4); 
                        obj.sim_output.rate_structure.b_af(t_counter,i) = ...
                            obj.m.hs(i).rate_structure.b_af;                        
                   end
