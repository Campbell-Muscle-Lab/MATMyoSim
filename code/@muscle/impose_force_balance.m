...
%     
%     % Set the new command length
%     obj.hs(1).command_length = obj.muscle_length;
%     
%     if (mode_value == -2)
%         % Length control
...
%             fsolve(tension_control_single_half_sarcomere, 0);
%         
%         % New length cannot be shorter than slack length
%         new_length = max([
%         
%     else
%         
