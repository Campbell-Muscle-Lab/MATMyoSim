function rate_structure = update_4D_3A(obj,time_step, m_props, delta_hsl)
...
r4 = obj.parameters.k_4_0 + ...
        obj.parameters.k_4_1 * ...
            (exp(obj.parameters.k_4_2 * abs(obj.myofilaments.x))-1) + ...
        obj.parameters.max_rate * (1 ./ ...
            (1 + exp(-obj.parameters.k_4_3 * ...
...
r9 = obj.parameters.k_9_0 + ...
        obj.parameters.max_rate * (1 ./ ...
            (1 + exp(-obj.parameters.k_9_1 * ...
                (obj.myofilaments.x - obj.parameters.k_9_2)))) + ...
        obj.parameters.max_rate * (1 ./ ...
            (1 + exp(obj.parameters.k_9_1 * ...
                (obj.myofilaments.x + obj.parameters.k_9_2))));   
...
r13 = obj.parameters.k__13_0 + ...
        obj.parameters.k__13_1 * ...
            (exp(obj.parameters.k__13_2 * abs(obj.myofilaments.x))-1) + ...
        obj.parameters.max_rate * (1 ./ ...
            (1 + exp(-obj.parameters.k__13_3 * ...
...
obj.rate_structure.r_off = r_off;
    ...
    function dy = derivs(time_step,y)
        ...
        dy(M6_ind) = (sum(J9) + J12) - ...
            (sum(J10) + J11);
        dy(M7_ind) = sum(J13) - sum(J14);
