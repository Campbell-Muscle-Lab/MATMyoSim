function rate_structure = update_beard_atp(obj,time_step, m_props, delta_hsl)
...
M5_ind = (2+(2*obj.myofilaments.no_of_x_bins)) + ...
    (1:obj.myofilaments.no_of_x_bins);
M6_ind = (2+(3*obj.myofilaments.no_of_x_bins)) + ...
    (1:obj.myofilaments.no_of_x_bins);
M7_ind = M6_ind(end) + 1;
...
r7 = obj.parameters.k_7_0 * ...
        exp(-obj.parameters.k_cb * obj.parameters.k_7_1 * ...
                obj.myofilaments.x ./ ...
                            (1e18 * obj.parameters.k_boltzmann * ...
                                obj.parameters.temperature));
r7 = r7 + obj.parameters.max_rate * (1 ./ ...
...
r11 = obj.parameters.k__11_0 + ...
        obj.parameters.max_rate * (1./ ...
            (1 + exp(-obj.parameters.k__11_1 * ...
                (obj.myofilaments.x - obj.parameters.k__11_2)))) + ...
        obj.parameters.max_rate * (1./ ...
            (1 + exp(obj.parameters.k__11_1 * ...
                (obj.myofilaments.x + obj.parameters.k__11_2))));
...
r12 = obj.parameters.k__12 * ...
        exp(-0.5 * obj.parameters.k_cb * (obj.myofilaments.x .^2) / ...
            (1e18 * obj.parameters.k_boltzmann * ...
                obj.parameters.temperature));
r12(r12>obj.parameters.max_rate)=obj.parameters.max_rate;
...
obj.rate_structure.r_off = r_off;
    ...
    function dy = derivs(time_step,y)
        ...
        J10 = r10 .* M6';
        J11 = r11 .* M6';
        J12 = r12 .* obj.myofilaments.bin_width * M7 * (N_on - N_bound);        J13 = r13 .* M4';
        J13 = r13 * M7;
        J14 = r14 * M2;
        ...
        for i=1:obj.myofilaments.no_of_x_bins
            ...
            dy(M5_ind(i)) = (J7(i) + J10(i)) - ...
                (J8(i) + J9(i));
            dy(M6_ind(i)) = (J9(i) + J12(i)) - ...
                (J10(i) + J11(i));
        end
        dy(M7_ind) = (sum(J11) + J14) - ...
            (sum(J12) + J13);
