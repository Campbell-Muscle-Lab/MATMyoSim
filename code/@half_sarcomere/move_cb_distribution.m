...
if (startsWith(obj.kinetic_scheme, 'beard_atp'))
    ...
    cbs_bound_before = sum(obj.myofilaments.y(3:(end-2)));
    ...
    % Try to manage cbs ripped off filaments
    cbs_lost = cbs_bound_before - sum(obj.myofilaments.y(3:(end-2)));
    obj.myofilaments.y(2) = obj.myofilaments.y(2) + cbs_lost;                
%     if (abs(cbs_lost) > 1e-5)
%         disp(sprintf('Warning - %.5f cbs lost during movement', cbs_lost))
%     end
...
%     cbs_bound_before = sum(obj.myofilaments.y(3:(end-3)));
...
%     % Try to manage cbs ripped off filaments
%     cbs_lost = cbs_bound_before - sum(obj.myofilaments.y(3:(end-3)));
%     obj.myofilaments.y(2) = obj.myofilaments.y(2) + cbs_lost;                
end
